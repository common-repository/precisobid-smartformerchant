    ...
    success: function(data) {
        ...
        if (data.status.statusCode == 'S_200') {
            ...
            jQuery('.totalFundRemain').html(data.totalRemainingFundAvailable + ' €');
                // console.log("payarrayLen"+data.payarrayLen);
                var i;
                ...
                console.log('https://api.preciso.net/api/plugin/getrebate?userId=' + jQuery('.userid').val() + '&token=' + jQuery('.token').val());
                jQuery.ajax({
                    type: 'GET',
    ...
    if (freqcp == '' || pv == '' || pc == '' || dailybud == '' || monthbud == '' || landing == '' || landingURL == 1) {
        ...
        if (freqcp > 255 || pc > 255 || pv > 255 || dailybud < 0 || monthbud < 0 || pv < 0 || pc < 0 || freqcp < 0) {
            ...
            if (parseInt(dailybud) > parseInt(monthbud)) {
                    ...
                    // console.log("dailybud:"+dailybud);
                    // console.log("monthbud"+monthbud);
                    // console.log("monthbud:"+monthbud);
    ...
    jQuery.ajax({
        ...
        success: function(data) {
            ...
            if (data.status.statusCode == 'S_200') {
                ...
                console.log("editarrlen:" + editarrLEn);
                if (editarrLEn == 9) {
